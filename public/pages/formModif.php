...
<?php
                switch($_GET["err"]){
                    ...
                    case "2":
                        echo "<h3 class='col-12 txtBlack text-center'>Mot de passe actuel incorrecte </h3>";
                    break;
...
<div class="container-fluid  my-3">
    ...
    <form action="public/functions/modification.php?id=<?php echo $id; ?>" method="post" >
        ...
        <div  class="col-sm-12 m-2">
            <button type="submit" name="submit" class="btn btn-secondary">Modifier</button>
        </div>
    </form>
</div>
<div class="container-fluid my-3">
    <form action="public/functions/modifAvatar.php?id=<?php echo $id; ?>" method="post" class="row g-2" enctype="multipart/form-data">
        <div class="col-sm-12 col-md-6 my-2">
            <label for="img" class="form-label"><strong>Choissisez votre Avatar : </strong></label>
            <input type="file" name='img' id="img" class="form-control">
        </div>
        <div  class="col-sm-12 m-2">
            <button type="submit" name="submitAvatar" class="btn btn-secondary">Upload</button>
        </div>
    </form>
</div>